...
// y=a^x (a为常数且以a>0，a≠1)
const FY = (a: number) => (x: number) => a ** x;
...
export const ExponentialSpiralLine: FC<any> = (props: any) => {
    const {
        width = 400,
        height = 400,
        style = {},
        ...
        data = {
            a: 2,
            minX: 0,
            maxX: 1500, // θ 角度 如： 0-360度
            minY: 0.01,
            maxY: 100000, // r值
        },
        title = "ExponentialSpiralLine",
    } = props;
    ...
    const y = useMemo(
        ...
        () => d3.scaleLog([data.minY, data.maxY], [0, outerRadius]).nice(),
